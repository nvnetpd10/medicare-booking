      ...
      {/*  u     */}
          ...
          <div className="container">
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              ...
              <div>
                ...
                <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:flex-row lg:items-center gap-5 
                 lg-gap-[30px]">
                    <div>
        ...
        <section>
          ...
          <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
            ...
            bottom-[50px]  left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:px-4 
            ...
            '>
              <div className='flex items-center justify-between'>
                ...
                <span className='w-5 h-5 lg:h-[34px] flex items-center justify-center 
